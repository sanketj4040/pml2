  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Store some data in localStorage to simulate successful registration
        localStorage.setItem("registeredManagerEmail", formData.email);
    ...
    <>
      <div className="header">
        ...
        <div className="header-text">
          ...
          <p>Join our project management team</p>
        </div>
      ...
      <div className="registration-container">
        <div className="registration-form-wrapper">
          ...
          <p className="form-subtitle">Please fill in your information to register as a Manager</p>
          ...
          <form onSubmit={handleSubmit} className="registration-form">
            ...
            <div className="form-footer">
              <button type="submit" className="register-button">Register as Manager</button>
              <p className="login-link">
                Already have an account? <Link to="/manager">Log in</Link>
              </p>
            </div>
          </form>
        </div>
